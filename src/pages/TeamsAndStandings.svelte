<script>
   ...
   [
	...
	const selectTeam = () => {
		selectedTeam = teams.filter( t => t.group == selectedGroup)[0].name;
	...
	<div class="teams-details-container">
		<div class="tabs">
			<div class="tab-list nav-section">
				<div class="nav">
					<div class="tab-btn" class:active={selectedGroup == "Group A"} on:click|preventDefault={e => selectedGroup = "Group A"}>Group A</div>
					<div class="tab-btn" class:active={selectedGroup == "Group B"} on:click|preventDefault={e => selectedGroup = "Group B"}>Group B</div>
					<div class="tab-btn" class:active={selectedGroup == "Group C"} on:click|preventDefault={e => selectedGroup = "Group C"}>Group C</div>
					<div class="tab-btn" class:active={selectedGroup == "Group D"} on:click|preventDefault={e => selectedGroup = "Group D"}>Group D</div>
				</div>
			</div>
			<div class="container">
					...
					<div class="col-md-8 col-sm-12 col-xs-12 teams-view-container">
						<div class="teams-details d-flex">
                           ...
                           progress.set(((1.4*scrollValue)/clientWidth)*(100))
									...
									{#each teams.filter(t => t.group == selectedGroup) as team}
										<div class="logo-click-card" class:active={selectedTeam == team.name} on:click|preventDefault={
											e => {
												selectedTeam = team.name;
											}
										}>
											<img src="images/teamLogos/{team.logo}" alt="">
										</div>
									{/each}
								</div>
                        <progress value={$progress} max="100" class="progress-bar-teams"></progress>
								<div class="team-player-sec">
									...
									{#if selectedTeam}
										{#each teams.find(t => t.name == selectedTeam).players as player }
